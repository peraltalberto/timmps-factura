...
public class CfProvAlbCustomEmpJpaController implements Serializable {
    ...
    public CfProvAlbCustomEmpJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    private List<CfProvAlbCustomEmp> findCfProvAlbCustomEmpEntities(boolean all, int maxResults, int firstResult) {
        ...
        try {
            ...
            cq.select(cq.from(CfProvAlbCustomEmp.class));
    ...
    public int getCfProvAlbCustomEmpCount() {
        ...
        try {
            CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
            Root<CfProvAlbCustomEmp> rt = cq.from(CfProvAlbCustomEmp.class);
