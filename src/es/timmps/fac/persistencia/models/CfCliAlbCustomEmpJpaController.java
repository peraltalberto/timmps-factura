...
public class CfCliAlbCustomEmpJpaController implements Serializable {
    ...
    public CfCliAlbCustomEmpJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    private List<CfCliAlbCustomEmp> findCfCliAlbCustomEmpEntities(boolean all, int maxResults, int firstResult) {
        ...
        try {
            Query q = em.createQuery("select object(o) from CfCliAlbCustomEmp as o");
            if (!all) {
    ...
    public int getCfCliAlbCustomEmpCount() {
        EntityManager em = getEntityManager();
        try {
            Query q = em.createQuery("select count(o) from CfCliAlbCustomEmp as o");
