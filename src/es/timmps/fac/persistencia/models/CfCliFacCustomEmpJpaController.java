...
public class CfCliFacCustomEmpJpaController implements Serializable {
    ...
    public CfCliFacCustomEmpJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    private List<CfCliFacCustomEmp> findCfCliFacCustomEmpEntities(boolean all, int maxResults, int firstResult) {
        ...
        try {
            Query q = em.createQuery("select object(o) from CfCliFacCustomEmp as o");
            if (!all) {
    ...
    public int getCfCliFacCustomEmpCount() {
        EntityManager em = getEntityManager();
        try {
            Query q = em.createQuery("select count(o) from CfCliFacCustomEmp as o");
